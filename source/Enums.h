...
{
	KING_BOB_OMB_DAMAGE_ANIM_FILE_ID    = 0x2bb,
	KING_BOB_OMB_GETUP_ANIM_FILE_ID     = 0x2bc,
	KING_BOB_OMB_JUMP_ANIM_FILE_ID      = 0x2bd,
	KING_BOB_OMB_JUMPED_ANIM_FILE_ID    = 0x2be,
	KING_BOB_OMB_LIFT_ANIM_FILE_ID      = 0x2bf,
	KING_BOB_OMB_START_ANIM_FILE_ID     = 0x2c0,
	KING_BOB_OMB_STRUGGLE_ANIM_FILE_ID  = 0x2c1,
	KING_BOB_OMB_THROW_ANIM_FILE_ID     = 0x2c2,
	KING_BOB_OMB_WAIT_1_ANIM_FILE_ID    = 0x2c3,
	KING_BOB_OMB_WAIT_2_ANIM_FILE_ID    = 0x2c4,
	KING_BOB_OMB_WALK_1_ANIM_FILE_ID    = 0x2c5,
	KING_BOB_OMB_WALK_2_ANIM_FILE_ID    = 0x2c6,
	KING_BOB_OMB_MODEL_FILE_ID          = 0x2c7,
	WIGGLER_BODY_1_MODEL_FILE           = 0x302,
	WIGGLER_BODY_1_TEXSEQ_FILE          = 0x303,
	WIGGLER_BODY_1_DAMAGE_ANIM_FILE     = 0x304,
	WIGGLER_BODY_1_WAIT_ANIM_FILE       = 0x305,
	WIGGLER_BODY_1_WALK_ANIM_FILE       = 0x306,
	WIGGLER_BODY_1_WALK_END_ANIM_FILE   = 0x307,
	WIGGLER_BODY_1_WALK_START_ANIM_FILE = 0x308,
	WIGGLER_BODY_2_MODEL_FILE           = 0x309,
	WIGGLER_BODY_2_TEXSEQ_FILE          = 0x30a,
	WIGGLER_BODY_2_DAMAGE_ANIM_FILE     = 0x30b,
	WIGGLER_BODY_2_WAIT_ANIM_FILE       = 0x30c,
	WIGGLER_BODY_2_WALK_ANIM_FILE       = 0x30d,
	WIGGLER_BODY_2_WALK_END_ANIM_FILE   = 0x30e,
	WIGGLER_BODY_2_WALK_START_ANIM_FILE = 0x30f,
	WIGGLER_BODY_3_MODEL_FILE           = 0x310,
	WIGGLER_BODY_3_TEXSEQ_FILE          = 0x311,
	WIGGLER_BODY_3_DAMAGE_ANIM_FILE     = 0x312,
	WIGGLER_BODY_3_WAIT_ANIM_FILE       = 0x313,
	WIGGLER_BODY_3_WALK_ANIM_FILE       = 0x314,
	WIGGLER_BODY_3_WALK_END_ANIM_FILE   = 0x315,
	WIGGLER_BODY_3_WALK_START_ANIM_FILE = 0x316,
	WIGGLER_BODY_4_MODEL_FILE           = 0x317,
	WIGGLER_BODY_4_TEXSEQ_FILE          = 0x318,
	WIGGLER_BODY_4_DAMAGE_ANIM_FILE     = 0x319,
	WIGGLER_BODY_4_WAIT_ANIM_FILE       = 0x31a,
	WIGGLER_BODY_4_WALK_ANIM_FILE       = 0x31b,
	WIGGLER_BODY_4_WALK_END_ANIM_FILE   = 0x31c,
	WIGGLER_BODY_4_WALK_START_ANIM_FILE = 0x31d,
	WIGGLER_HEAD_MODEL_FILE             = 0x31e,
	WIGGLER_HEAD_TEXSEQ_FILE            = 0x31f,
	WIGGLER_HEAD_DAMAGE_ANIM_FILE       = 0x320,
	WIGGLER_HEAD_WAIT_ANIM_FILE         = 0x321,
	WIGGLER_HEAD_WALK_ANIM_FILE         = 0x322,
	WIGGLER_HEAD_WALK_END_ANIM_FILE     = 0x323,
	WIGGLER_HEAD_WALK_START_ANIM_FILE   = 0x324,
	EYEROCK_CLSN_FILE_ID                = 0x332,
	EYEROCK_L_CLOSE_TEXSEQ_FILE_ID      = 0x333,
	EYEROCK_R_CLOSE_TEXSEQ_FILE_ID      = 0x334,
	EYEROCK_L_DAMAGE_ANIM_FILE_ID       = 0x335,
	EYEROCK_R_DAMAGE_ANIM_FILE_ID       = 0x336,
	EYEROCK_L_DEAD_ANIM_FILE_ID         = 0x337,
	EYEROCK_R_DEAD_ANIM_FILE_ID         = 0x338,
	EYEROCK_MODEL_FILE_ID               = 0x339,
	EYEROCK_L_MODEL_FILE_ID             = 0x33a,
	EYEROCK_L_MOVE_CLSN_FILE_ID         = 0x33b,
	EYEROCK_R_MOVE_CLSN_FILE_ID         = 0x33c,
	EYEROCK_L_OPEN_TEXSEQ_FILE_ID       = 0x33d,
	EYEROCK_R_OPEN_TEXSEQ_FILE_ID       = 0x33e,
	EYEROCK_R_MODEL_FILE_ID             = 0x33f,
	EYEROCK_L_WAIT_END_ANIM_FILE_ID     = 0x340,
	EYEROCK_R_WAIT_END_ANIM_FILE_ID     = 0x341,
	EYEROCK_L_WAIT_ANIM_FILE_ID         = 0x342,
	EYEROCK_L_WAIT_CLSN_FILE_ID         = 0x343,
	EYEROCK_R_WAIT_ANIM_FILE_ID         = 0x344,
	EYEROCK_R_WAIT_CLSN_FILE_ID         = 0x345,
	EYEROCK_L_WAKE_UP_ANIM_FILE_ID      = 0x346,
	EYEROCK_R_WAKE_UP_ANIM_FILE_ID      = 0x347,
	BOWSER_DAMAGE_ANIM_FILE_ID          = 0x35f,
	BOWSER_DAMAGE_2_ED_ANIM_FILE_ID     = 0x360,
	BOWSER_DAMAGE_2_ED_TEXSEQ_FILE_ID   = 0x361,
	BOWSER_DAMAGE_2_ST_ANIM_FILE_ID     = 0x362,
	BOWSER_DAMAGE_2_ST_TEXSEQ_FILE_ID   = 0x363,
	BOWSER_DEAD_ANIM_FILE_ID            = 0x364,
	BOWSER_DEAD_TEXSEQ_FILE_ID          = 0x365,
	BOWSER_DEAD_ED_ANIM_FILE_ID         = 0x366,
	BOWSER_DEAD_ST_ANIM_FILE_ID         = 0x367,
	BOWSER_DUSH_ANIM_FILE_ID            = 0x368,
	BOWSER_DUSH_ED_ANIM_FILE_ID         = 0x369,
	BOWSER_DUSH_ST_ANIM_FILE_ID         = 0x36a,
	BOWSER_FIRE_ANIM_FILE_ID            = 0x36b,
	BOWSER_FIRE_2_ANIM_FILE_ID          = 0x36c,
	BOWSER_FIRE_3_ANIM_FILE_ID          = 0x36d,
	BOWSER_FIRE_3_ED_ANIM_FILE_ID       = 0x36e,
	BOWSER_FIRE_3_ST_ANIM_FILE_ID       = 0x36f,
	BOWSER_FIRE_ED_ANIM_FILE_ID         = 0x370,
	BOWSER_FIRE_ST_ANIM_FILE_ID         = 0x371,
	BOWSER_HOLD_ANIM_FILE_ID            = 0x372,
	BOWSER_HOLD_TEXSEQ_FILE_ID          = 0x373,
	BOWSER_HOLD_ST_ANIM_FILE_ID         = 0x374,
	BOWSER_JUMP_1_ANIM_FILE_ID          = 0x375,
	BOWSER_JUMP_2_ANIM_FILE_ID          = 0x376,
	BOWSER_MODEL_FILE_ID                = 0x377,
	BOWSER_STAND_UP_ANIM_FILE_ID        = 0x378,
	BOWSER_STRETCH_ANIM_FILE_ID         = 0x379,
	BOWSER_THROW_ANIM_FILE_ID           = 0x37a,
	BOWSER_THROW_TEXSEQ_FILE_ID         = 0x37b,
	BOWSER_VEXING_ANIM_FILE_ID          = 0x37c,
	BOWSER_WAIT_TEXSEQ_FILE_ID          = 0x37d,
	BOWSER_WAIT_1_ANIM_FILE_ID          = 0x37e,
	BOWSER_WALK_ANIM_FILE_ID            = 0x37f,
	BOWSER_WALK_ED_ANIM_FILE_ID         = 0x380,
	BOWSER_WALK_ST_ANIM_FILE_ID         = 0x381,
	SPIKE_BOMB_MODEL_FILE_ID            = 0x382,
	BOWSER_SHOCKWAVE_ANIM_FILE_ID       = 0x383,
	BOWSER_SHOCKWAVE_MODEL_FILE_ID      = 0x384,
	BOWSER_SHOCKWAVE_TEXSEQ_FILE_ID     = 0x385,
	...
	BOWSER_FIRE_SEA_ARENA_MODEL_FILE_ID = 0x623,
	BOWSER_FIRE_SEA_ARENA_CLSN_FILE_ID  = 0x624,
	BOWSER_SKY_PLATFORM_A_MODEL_FILE_ID = 0x625,
	BOWSER_SKY_PLATFORM_A_CLSN_FILE_ID  = 0x626,
	BOWSER_SKY_PLATFORM_B_MODEL_FILE_ID = 0x627,
	BOWSER_SKY_PLATFORM_B_CLSN_FILE_ID  = 0x628,
	BOWSER_SKY_PLATFORM_C_MODEL_FILE_ID = 0x629,
	BOWSER_SKY_PLATFORM_C_CLSN_FILE_ID  = 0x62a,
	BOWSER_SKY_PLATFORM_D_MODEL_FILE_ID = 0x62b,
	BOWSER_SKY_PLATFORM_D_CLSN_FILE_ID  = 0x62c,
	BOWSER_SKY_PLATFORM_E_MODEL_FILE_ID = 0x62d,
	BOWSER_SKY_PLATFORM_E_CLSN_FILE_ID  = 0x62e,
	BOWSER_SKY_PLATFORM_F_MODEL_FILE_ID = 0x62f,
	BOWSER_SKY_PLATFORM_F_CLSN_FILE_ID  = 0x630,
	BOWSER_SKY_PLATFORM_G_MODEL_FILE_ID = 0x631,
	BOWSER_SKY_PLATFORM_G_CLSN_FILE_ID  = 0x632,
	BOWSER_SKY_PLATFORM_H_MODEL_FILE_ID = 0x633,
	BOWSER_SKY_PLATFORM_H_CLSN_FILE_ID  = 0x634,
	BOWSER_SKY_PLATFORM_I_MODEL_FILE_ID = 0x635,
	BOWSER_SKY_PLATFORM_I_CLSN_FILE_ID  = 0x636,
	BOWSER_SKY_PLATFORM_J_MODEL_FILE_ID = 0x637,
	BOWSER_SKY_PLATFORM_J_CLSN_FILE_ID  = 0x638,
