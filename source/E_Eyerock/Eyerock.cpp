...
extern "C"
{
	...
	void FUN_02118cb8(Eyerock* eyerock);
	void FUN_02118c00(Eyerock* eyerock);
	void FUN_02118be0(Eyerock* eyerock);
	void FUN_02118b28(Eyerock* eyerock);
	void FUN_02117bd0(Eyerock* eyerock);
	void FUN_021175e8(Eyerock* eyerock);
	void FUN_02118b08(Eyerock* eyerock);
	void FUN_02118a50(Eyerock* eyerock);
	void FUN_02118a30(Eyerock* eyerock);
	void FUN_021189c0(Eyerock* eyerock);
	void FUN_021175bc(Eyerock* eyerock);
	void FUN_021171b0(Eyerock* eyerock);
	void FUN_021189a0(Eyerock* eyerock);
	void FUN_02118954(Eyerock* eyerock);
	void FUN_02118934(Eyerock* eyerock);
	void FUN_021188b0(Eyerock* eyerock);
	void FUN_02117190(Eyerock* eyerock);
	void FUN_02116db0(Eyerock* eyerock);
	void FUN_021187c8(Eyerock* eyerock);
	void FUN_02118678(Eyerock* eyerock);
	void FUN_02118658(Eyerock* eyerock);
	void FUN_02118604(Eyerock* eyerock);
	void FUN_02116d14(Eyerock* eyerock);
	void FUN_02116c6c(Eyerock* eyerock);
	void FUN_021185e4(Eyerock* eyerock);
	void FUN_021184e0(Eyerock* eyerock);
	void FUN_0211944c(Eyerock* eyerock);
	void FUN_02119398(Eyerock* eyerock);
	void FUN_02119348(Eyerock* eyerock);
	void FUN_0211903c(Eyerock* eyerock);
	void FUN_021184c0(Eyerock* eyerock);
	void FUN_02118188(Eyerock* eyerock);
	void FUN_0211901c(Eyerock* eyerock);
	void FUN_02118e04(Eyerock* eyerock);
	void FUN_02118de0(Eyerock* eyerock);
	void FUN_02118cdc(Eyerock* eyerock);
	void FUN_02118168(Eyerock* eyerock);
	void FUN_02117bf0(Eyerock* eyerock);
	...
	Vector3 UNK_0211ad18 = Vector3{ 0_f, 0x20000_f, -0x10000_f }; // 0x0211ad18
...
SharedFilePtr Eyerock::modelFile;
SharedFilePtr Eyerock::clsnFile;

SharedFilePtr Eyerock::handModelFiles[2];

SharedFilePtr Eyerock::waitClsnFiles[2];
SharedFilePtr Eyerock::moveClsnFiles[2];

SharedFilePtr Eyerock::closeTexSeqFiles[2];
SharedFilePtr Eyerock::openTexSeqFiles[2];

SharedFilePtr Eyerock::wakeUpAnimFiles[2];
SharedFilePtr Eyerock::waitAnimFiles[2];
SharedFilePtr Eyerock::waitEndAnimFiles[2];
SharedFilePtr Eyerock::damageAnimFiles[2];
SharedFilePtr Eyerock::deadAnimFiles[2];

SpawnInfo Eyerock::spawnData = 
{
	&FUN_0211a370,
	0x00b0,
	0x0063,
...
LAB_02116170:
	...
	str     r0, [r13]
	mov     r1, #0x0
	ldr     r0, =_ZN7Eyerock15damageAnimFilesE + 0
	str     r1, [r13, #0x4]
	ldr     r1, [r0, #0x4]
	add     r0, r6, #0x360
	mov     r2, #0x4
	...
	mov     r2, #0x0
	ldr     r0, =#0x448
	ldr     r1, =_ZN7Eyerock16closeTexSeqFilesE + 0
	str     r2, [r13]
	ldr     r1, [r1, #0x4]
	add     r0, r6, r0
	mov     r2, #0x40000000
...
LAB_021161e4:
	...
	str     r0, [r13]
	mov     r1, #0x0
	ldr     r0, =_ZN7Eyerock15damageAnimFilesE + 8
	str     r1, [r13, #0x4]
	ldr     r1, [r0, #0x4]
	add     r0, r6, #0x360
	mov     r2, #0x4
	...
	mov     r2, #0x0
	ldr     r0, =#0x448
	ldr     r1, =_ZN7Eyerock16closeTexSeqFilesE + 8
	str     r2, [r13]
	ldr     r1, [r1, #0x4]
	add     r0, r6, r0
	mov     r2, #0x40000000
...
FUN_02116390:
	...
	mov     r2, #0x0
	ldr     r0, =#0x448
	ldr     r1, =_ZN7Eyerock15openTexSeqFilesE + 0
	str     r2, [r13]
	ldr     r1, [r1, #0x4]
	add     r0, r4, r0
	mov     r2, #0x40000000
...
LAB_02116400:
	mov     r2, #0x0
	ldr     r0, =#0x448
	ldr     r1, =_ZN7Eyerock15openTexSeqFilesE + 8
	str     r2, [r13]
	ldr     r1, [r1, #0x4]
	add     r0, r4, r0
	mov     r2, #0x40000000
...
FUN_021164ec:
	...
	str     r0, [r13]
	mov     r3, #0x0
	ldr     r0, =_ZN7Eyerock13waitAnimFilesE + 0
	str     r3, [r13, #0x4]
	ldr     r1, [r0, #0x4]
	add     r0, r4, #0x360
	mov     r2, #0x4
...
LAB_02116588:
	...
	str     r0, [r13]
	mov     r3, #0x0
	ldr     r0, =_ZN7Eyerock13waitAnimFilesE + 8
	str     r3, [r13, #0x4]
	ldr     r1, [r0, #0x4]
	add     r0, r4, #0x360
	mov     r2, #0x4
...
FUN_021165cc:
	...
	str     r0, [r13]
	mov     r1, #0x0
	ldr     r0, =_ZN7Eyerock16waitEndAnimFilesE + 0
	str     r1, [r13, #0x4]
	ldr     r1, [r0, #0x4]
	add     r0, r4, #0x360
	mov     r2, #0x4
...
LAB_02116634:
	...
	str     r0, [r13]
	mov     r1, #0x0
	ldr     r0, =_ZN7Eyerock16waitEndAnimFilesE + 8
	str     r1, [r13, #0x4]
	ldr     r1, [r0, #0x4]
	add     r0, r4, #0x360
	mov     r2, #0x4
...
LAB_0211679c:
	...
	str     r1, [r13]
	ldr     r2, =#0x83c
	ldr     r1, =_ZN7Eyerock13waitClsnFilesE + 8
	str     r3, [r13, #0x4]
	ldr     r1, [r1, #0x4]
	ldr     r3, =#0x199
	add     r0, r4, r0
...
LAB_021167dc:
	...
	str     r1, [r13]
	ldr     r2, =#0x83c
	ldr     r1, =_ZN7Eyerock13waitClsnFilesE + 0
	str     r3, [r13, #0x4]
	ldr     r1, [r1, #0x4]
	ldr     r3, =#0x199
	add     r0, r4, r0
...
FUN_02116d14:
	...
	mov     r1, #0x1000
	str     r1, [r13]
	ldr     r1, =_ZN7Eyerock13deadAnimFilesE + 0
	str     r2, [r13, #0x4]
	ldr     r1, [r1, #0x4]
	add     r0, r0, #0x360
	mov     r2, #0x4
...
LAB_02116d74:
	mov     r1, #0x1000
	str     r1, [r13]
	ldr     r1, =_ZN7Eyerock13deadAnimFilesE + 8
	str     r2, [r13, #0x4]
	ldr     r1, [r1, #0x4]
	add     r0, r0, #0x360
	mov     r2, #0x4
...
LAB_02116fc8:
	...
	str     r1, [r13]
	ldr     r2, =#0x83c
	ldr     r1, =_ZN7Eyerock13moveClsnFilesE + 8
	str     r3, [r13, #0x4]
	ldr     r1, [r1, #0x4]
	ldr     r3, =#0x199
	add     r0, r4, r0
...
LAB_02117008:
	...
	str     r1, [r13]
	ldr     r2, =#0x83c
	ldr     r1, =_ZN7Eyerock13moveClsnFilesE + 0
	str     r3, [r13, #0x4]
	ldr     r1, [r1, #0x4]
	ldr     r3, =#0x199
	add     r0, r4, r0
...
FUN_021187c8:
	...
	str     r0, [r13]
	mov     r1, #0x0
	ldr     r0, =_ZN7Eyerock15wakeUpAnimFilesE + 0
	str     r1, [r13, #0x4]
	ldr     r1, [r0, #0x4]
	add     r0, r4, #0x360
	mov     r2, #0x4
...
LAB_02118830:
	...
	str     r0, [r13]
	mov     r1, #0x0
	ldr     r0, =_ZN7Eyerock15wakeUpAnimFilesE + 8
	str     r1, [r13, #0x4]
	ldr     r1, [r0, #0x4]
	add     r0, r4, #0x360
	mov     r2, #0x4
...
LAB_0211967c:
	...
	cmp     r0, #0x0
	bne     LAB_02119738
	ldr     r0, =_ZN7Eyerock9modelFileE
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock14handModelFilesE + 8
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock14handModelFilesE + 0
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock16closeTexSeqFilesE + 8
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock15openTexSeqFilesE + 8
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock16closeTexSeqFilesE + 0
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock15openTexSeqFilesE + 0
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock15damageAnimFilesE + 0
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock15damageAnimFilesE + 8
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock13deadAnimFilesE + 0
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock13deadAnimFilesE + 8
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock16waitEndAnimFilesE + 0
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock16waitEndAnimFilesE + 8
	...
	ldr     r0, =_ZN7Eyerock15wakeUpAnimFilesE + 8
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock8clsnFileE
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock13moveClsnFilesE + 0
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock13moveClsnFilesE + 8
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock13waitClsnFilesE + 0
	bl      _ZN13SharedFilePtr7ReleaseEv
	ldr     r0, =_ZN7Eyerock13waitClsnFilesE + 8
	bl      _ZN13SharedFilePtr7ReleaseEv
LAB_02119738:
	mov     r0, #0x1
	pop     { r4, r14 }
...
LAB_02119d64:
	...
	b       LAB_02119ed8
LAB_02119e2c:
	ldr     r1, =_ZN7Eyerock14handModelFilesE + 8
	add     r0, r4, #0x360
	ldr     r1, [r1, #0x4]
	mov     r2, #0x1
	mvn     r3, #0x0
	...
	b       LAB_02119ed8
LAB_02119e84:
	ldr     r1, =_ZN7Eyerock14handModelFilesE + 0
	add     r0, r4, #0x360
	ldr     r1, [r1, #0x4]
	mov     r2, #0x1
	mvn     r3, #0x0
